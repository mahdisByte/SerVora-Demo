...
const ProfilePage = () => {
  ...
  const handleProviderApply = async (formData) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8000/api/provider-applications",
        {
  ...
  if (loading) return <div className="servora-container">Loading profile...</div>;
      ...
      <div className="servora-hero">
        ...
        <div className="servora-container servora-hero-content">
          ...
          <div className="servora-hero-right">
            ...
            {!isProvider && !hasPendingApplication && (
              <button 
        ...
        <div className="servora-content">
          ...
          {activeTab === "appointments" && (
            <section className="servora-card">
              ...
              {loadingBookings ? (
                <div className="servora-loading-state">
                  <div className="servora-spinner"></div>
